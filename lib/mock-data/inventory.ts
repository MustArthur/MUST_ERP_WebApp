...
export const mockStockItems: StockItem[] = [
  ...
  // Fruits (from Item.csv - ซีพี แอ๊กซ์ตร้า)
  {
    id: 'item-strawberry-fruit',
    code: 'RM-STRAWBERRY-FRUIT',
    name: 'สตรอว์เบอร์รี่',
    type: 'RAW_MATERIAL',
    uom: 'KG',
    defaultWarehouseId: 'wh-rm-cold',
    ...
    reorderPoint: 20,
    requiresQC: true,
    qcTemplateId: 'qct-raw-fruit',
    costPerUnit: 180,
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2026-01-31T00:00:00Z',
  },
  {
    id: 'item-blueberry-fruit',
    code: 'RM-BLUEBERRY-FRUIT',
    name: 'บลูเบอร์รี่',
    type: 'RAW_MATERIAL',
    uom: 'KG',
    defaultWarehouseId: 'wh-rm-cold',
  ...
  {
    id: 'item-lychee-fruit',
    code: 'RM-LYCHEE-FRUIT',
    name: 'ลิ้นจี่',
    type: 'RAW_MATERIAL',
    uom: 'KG',
    defaultWarehouseId: 'wh-rm-cold',
  ...
  {
    id: 'item-passionfruit',
    code: 'RM-PASSIONFRUIT',
    name: 'เสาวรส',
    type: 'RAW_MATERIAL',
    uom: 'KG',
    defaultWarehouseId: 'wh-rm-cold',
